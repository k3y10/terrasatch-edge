...
<style>
:root{{color-scheme:dark;--bg:#080a09;--surface:#111412;--surface2:#151816;--line:#303531;--soft:#242925;--text:#f7f7f4;--muted:#a9aeaa;--orange:#ff8a00;--green:#35d778;--amber:#f0b44c;--red:#ff625c;--ui:"Segoe UI",Inter,system-ui,sans-serif;--display:"Arial Narrow","Roboto Condensed","Segoe UI",sans-serif}}
...
.app-header{{display:flex;align-items:center;justify-content:space-between;gap:24px}}.brand{{display:flex;align-items:center;gap:12px}}
.brand-mark{{width:48px;height:48px;border:2px solid var(--orange);border-radius:50%;display:grid;place-items:center}}.brand-mark svg{{width:32px;height:32px}}
...
<header class="app-header">
  <div>
    <div class="brand"><span class="brand-mark" aria-hidden="true"><svg viewBox="0 0 40 40" fill="none"><path d="M6 29 15 15l5 7 4-5 10 12H6Z" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><path d="M12 29v-6m16 6v-8M20 10V5m-3 4 3-4 3 4" stroke="#ff8a00" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg></span><div class="brand-name">TerraSatch <span>Edge</span></div></div>
