    ...
    steps = "".join(
        [
            ...
            _step(
                ...
                body="""
                <p class="step-note">Pair this field gateway to the correct TerraSatch organization and site. This is the anchor for phones, radios, provider integrations, and future field nodes.</p>
...
<dialog id="settingsDialog">
  ...
  <div class="dialog-body"><p class="dialog-intro">These settings affect only this Edge gateway. Workspace pairing controls the organization and field-site assignment.</p>
  ...
  </div><div class="form-actions"><button class="primary-action" type="submit">Save gateway settings</button></div></form></div>
</dialog>
