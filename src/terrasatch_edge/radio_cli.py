...
def _radio_source(base_source: str, channel: int) -> str:
    ...
    return radio_source(base_source, channel)
        ...
        while True:
            ...
            try:
                result = ingest_audio_file(
                    ...
                    source=source,
                    channel_id=load_resolved_radio_config(config).config.channel_id_for(selected_channel),
                    hotwords=hotwords,
                    initial_prompt=(
                        "TerraSatch field radio traffic."
                    ),
